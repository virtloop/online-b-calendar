...
More Context: [tc39-notes](https://github.com/rwaldron/tc39-notes/blob/master/es7/2017-07/july-29.md#611-the-scope-of-use-strict-with-respect-to-destructuring-in-parameter-lists)
...
The only change is to remove the `babel-runtime` dependency by compiling with Babel's ES2017 loose mode. So using babylon standalone should be smaller.
