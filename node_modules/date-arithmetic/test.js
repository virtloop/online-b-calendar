...
assert.equal(+dateMath.add(date, 1, 'year'),    +(new Date(2017, 1, 18, 8, 25, 30, 5)), 'add year')
...
assert.equal(+dateMath.min(date, new Date(2017, 0, 1, 0, 0, 0, 0)), +date, 'min')
...
assert.ok(dateMath.lte(date,  new Date(2017,0,1,0,0,0,0), 'year'),  'lte year')
assert.ok(dateMath.lt(date,   new Date(2017,0,1,0,0,0,0),  'year'), 'lt year')
