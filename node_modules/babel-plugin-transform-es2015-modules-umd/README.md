# babel-plugin-transform-es2017-modules-umd

> This plugin transforms ES2017 modules to [Universal Module Definition (UMD)](https://github.com/umdjs/umd).
...
```sh
npm install --save-dev babel-plugin-transform-es2017-modules-umd
```
...
```json
{
  "plugins": ["transform-es2017-modules-umd"]
}
```
...
```sh
babel --plugins transform-es2017-modules-umd script.js
```
