...
- _format_: formats validation mode ('fast' by default). Pass 'full' for more correct and slow validation or `false` not to validate formats at all. E.g., 25:00:00 and 2017/14/33 will be invalid time and date in 'full' mode but it will be valid in 'fast' mode.
