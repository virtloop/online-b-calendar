...
### Dynamic class names with ES2017

If you're in an environment that supports [computed keys](http://www.ecma-international.org/ecma-262/6.0/#sec-object-initializer) (available in ES2017 and Babel) you can use dynamic class names:
...
_Note that in ES2017 environments, it may be better to use the "dynamic class names" approach documented above._
