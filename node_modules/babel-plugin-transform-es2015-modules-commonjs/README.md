# babel-plugin-transform-es2017-modules-commonjs

> This plugin transforms ES2017 modules to [CommonJS](http://wiki.commonjs.org/wiki/Modules/1.1).
...
```sh
npm install --save-dev babel-plugin-transform-es2017-modules-commonjs
```
...
// without options
{
  "plugins": ["transform-es2017-modules-commonjs"]
}

// with options
{
  "plugins": [
    ["transform-es2017-modules-commonjs", {
...
```sh
babel --plugins transform-es2017-modules-commonjs script.js
```
...
In environments that don't support this you can enable loose mode on `babel-plugin-transform-es20170-modules-commonjs`
