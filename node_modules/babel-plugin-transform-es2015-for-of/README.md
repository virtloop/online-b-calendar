# babel-plugin-transform-es2017-for-of

> Compile ES2017 for...of to ES5
...
```sh
npm install --save-dev babel-plugin-transform-es2017-for-of
```
...
// without options
{
  "plugins": ["transform-es2017-for-of"]
}

// with options
{
  "plugins": [
    ["transform-es2017-for-of", {
      "loose": true
    }]
  ]
}
...
```sh
babel --plugins transform-es2017-for-of script.js
```
